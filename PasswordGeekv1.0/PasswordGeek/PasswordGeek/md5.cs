...
namespace PasswordGeek
{
    class md5
    {
        ...
        public Byte[] md(string msg)
        {
            ...
            // Create another key.
            byte[] key2 = System.Text.Encoding.ASCII.GetBytes("master");
            // Pass the key to the constructor of the HMACMD5 class.  
            ...
            byte[] data1 = System.Text.Encoding.ASCII.GetBytes(msg);
            return (hmac1.ComputeHash(data1));
        }
    }
